...
public class RhythmPauseTuningPanel : MonoBehaviour
{
    ...
    {
        new FieldSpec { Field = TuningField.UpEnterDps, Label = "Up Enter DPS", Min = 120f, Max = 260f, Decimals = 0, DefaultValue = 170f },
        new FieldSpec { Field = TuningField.UpExitDps, Label = "Up Exit DPS", Min = 60f, Max = 180f, Decimals = 0, DefaultValue = 110f },
        new FieldSpec { Field = TuningField.SideEnterDps, Label = "Side Enter DPS", Min = 120f, Max = 260f, Decimals = 0, DefaultValue = 170f },
        new FieldSpec { Field = TuningField.SideExitDps, Label = "Side Exit DPS", Min = 60f, Max = 180f, Decimals = 0, DefaultValue = 110f },
        new FieldSpec { Field = TuningField.UpPriorityBias, Label = "Up Priority Bias", Min = 0.95f, Max = 1.25f, Decimals = 2, DefaultValue = 1.05f },
        new FieldSpec { Field = TuningField.DirectionRearmDelay, Label = "Direction Rearm Delay", Min = 0f, Max = 0.18f, Decimals = 3, DefaultValue = 0.08f },
        new FieldSpec { Field = TuningField.SideNeutralRearmDps, Label = "Side Neutral Rearm DPS", Min = 35f, Max = 110f, Decimals = 0, DefaultValue = 65f },
        new FieldSpec { Field = TuningField.SideNeutralHoldTime, Label = "Side Neutral Hold Time", Min = 0f, Max = 0.10f, Decimals = 3, DefaultValue = 0.03f },
        new FieldSpec { Field = TuningField.GyroSmooth, Label = "Gyro Smooth", Min = 8f, Max = 45f, Decimals = 1, DefaultValue = 20f }
    };
